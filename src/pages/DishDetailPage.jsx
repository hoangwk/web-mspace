      ...
      <div className="dish-page-hero">
        ...
        <div className="dish-page-hero-overlay">
          <div className="container">
            <button className="dish-page-back" onClick={() => navigate('/mon-an')}>
              ← Quay lại thực đơn
            </button>
          </div>
        </div>
      ...
      <div className="container">
        <div className="dish-page-content">
          ...
          <div className="dish-page-main">
            <div className="dish-category dish-page-category">{dish.category}</div>
          ...
          <div className="dish-page-sidebar">
            ...
            <div className="dish-page-cta-card">
              ...
              <p>Liên hệ với M.SPACE để đặt thực đơn cho văn phòng hoặc gia đình của bạn.</p>
              <button
              ...
              <button
                ...
                style={{ width: '100%', marginTop: '0.75rem', color: 'var(--primary-color)', borderColor: 'var(--primary-color)' }}
